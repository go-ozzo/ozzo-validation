...
var (
	...
	// CurrencyCode validates if a string is a valid, currently active ISO 4217 currency code.
	CurrencyCode = validation.NewStringRuleWithError(isISO4217CurrencyCode, ErrCurrencyCode)
